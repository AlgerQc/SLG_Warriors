...
namespace SLGame
{
    public class MapNavigator
    {
        ...
        {
            //初始化一定数量的导航数据
            navigationDataPool = new List<NavigationData>(GameConst.WorldMapMaxTryTimes);
            for (int i = 0; i < GameConst.WorldMapMaxTryTimes; ++i)
            {
            ...
            List<GridUnitData> searched)
        {
            ...
            int minStep = GameConst.Infinity;
